export default {
  ...
  header: {
    img:
    'https://scontent.fceb2-1.fna.fbcdn.net/v/t1.6435-9/240795109_6616530535031117_8253175474582806285_n.jpg?_nc_cat=111&ccb=1-5&_nc_sid=730e14&_nc_eui2=AeHsTf_Xz-Al9S3MguhcFSsDUMEA2_buBa5QwQDb9u4FrkkFjrunndB6sBVlY_R4NNUc-_Xv4FEuIpkuKemVFKkq&_nc_ohc=n15OIV2qUaMAX-r6ZV2&tn=GvEcMksaCKcT3ST-&_nc_ht=scontent.fceb2-1.fna&oh=a4eb56735a208891375133c155f4ec32&oe=615227A7',
    imgPlaceholder:
    ...
    text: ['Hi!', "It's me RJ Fajardo.", 'I am '],
    typical: [
      'web developer. 🖥',
      2000,
      'Mobile Developer',
  ...
  work: {
    ...
    desc:
      'Here are my sample projects source code which are not hosted live.'
  },
  stack: {
    title: 'Stack',
    tech: [
    ...
    desc: `Technology Stack I used to most of my projects`,
  },
  contact: {
    title: 'Ping Me!',
    desc:
